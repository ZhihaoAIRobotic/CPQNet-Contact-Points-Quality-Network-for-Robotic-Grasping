...
class URScript(object):
    ...
    def _socket_send_line(self,message, socket_name):
        msg = "socket_send_line(\"{}\",\"{}\")".format(message,socket_name)  # noqa
        self.add_line_to_program(msg)
        self._sync()
    ...
    def _socket_set_var(self, var, value, socket_name):
        ...
        self.add_line_to_program(msg)
        self._sync()
    def _to_str(self,var,outstr):
        msg="\"{}\":=to_str(\"{}\")".format(outstr,var)
        self.add_line_to_program(msg)
        self._sync()
