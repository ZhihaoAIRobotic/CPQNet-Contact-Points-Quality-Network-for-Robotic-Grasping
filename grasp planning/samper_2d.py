...
class AntipodalDepthImageGraspSampler(ImageGraspSampler):
    ...
    def _sample_antipodal_grasps(self,
        ...
        '''
        print(edge_pixels)
        print(depth_im._data)
        for i in edge_pixels:
            print(depth_im._data[i[0],i[1]])
        '''
        if visualize:
        ...
        while k < sample_size and len(grasps) < num_samples:
            ...
            depth_grasp = depth_grasp*0.7 + 0.3*depth_im[grasp_center[0],grasp_center[1]]
